...
if (!$conn) {
  ...
  if (!isset($_GET['cari'])) {
    ...
    $query = mysqli_query($conn, "SELECT * FROM paket WHERE nama_paket LIKE '%" . $_GET['cari'] . "%'");
  }
  ...
  require_once 'header.php';
    ...
    <div class="container mt-5">
        ...
        <div class="col">
          <form class="form-inline pull-right" action="" method="GET">
            <div class="form-group mx-sm-3 mb-2">
              <input type="text" name="cari" class="form-control" placeholder="Cari Paket">
            </div>
      ...
      <table class="table">
        ...
        <a href="../../frontend/paketInternetTv.php"><button class="btn btn-danger">kembali ke menu</button></a>
      </div>
